...
| [0011](./0011-data-converter-engine.md) | Data converter engine: DuckDB-WASM (CSV/JSON/Parquet) | Accepted |
| [0012](./0012-encrypted-vault-crypto.md) | Encrypted vault crypto: Argon2id + AES-256-GCM, zero-recovery | Accepted |
