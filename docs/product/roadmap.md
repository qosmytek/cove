...
[vault spike](../engineering/phase-4-vault-spike.md) set the Argon2 params (46 MiB/t1, confirmed on the
A54 at ~1 s). On-device AI is the remaining Phase 4 capability.
